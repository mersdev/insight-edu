              ...
              <form className="space-y-4" onSubmit={handleLogin}>
                ...
                <div className="mt-6 pt-2">
                    ...
                    <div className="grid grid-cols-3 gap-2">
                        ...
                        <button type="button" onClick={() => demoLogin('sarah@edu.com', '123')} className="flex flex-col items-center justify-center py-2 px-1 border rounded-lg hover:bg-gray-50 transition-all text-center group bg-white shadow-sm">
                        ...
                        <button type="button" onClick={() => demoLogin('parent.ali@edu.com', '123')} className="flex flex-col items-center justify-center py-2 px-1 border rounded-lg hover:bg-gray-50 transition-all text-center group bg-white shadow-sm">
