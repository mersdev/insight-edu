...
export const TRANSLATIONS = {
  en: {
    ...
    sendingReport: 'Preparing WhatsApp message...',
    reportWhatsAppSuccess: 'Report opened in WhatsApp.',
    reportWhatsAppFailure: 'Failed to open WhatsApp message.',
    reportWhatsAppPhoneMissing: 'Parent phone number is missing.',
    sendLoginWhatsApp: 'Send login via WhatsApp',
    whatsAppPhoneMissing: 'Add a phone number to send WhatsApp messages.',
    whatsAppButtonLabel: 'WhatsApp login',
    save: 'Save',
    cancel: 'Cancel',
    add: 'Add',
    edit: 'Edit',
  ...
  zh: {
    ...
    sendingReport: '正在准备 WhatsApp 消息...',
    reportWhatsAppSuccess: '报告已在 WhatsApp 中打开。',
    reportWhatsAppFailure: '无法准备 WhatsApp 报告消息。',
    reportWhatsAppPhoneMissing: '缺少家长手机号码。',
    sendLoginWhatsApp: '通过WhatsApp发送登录信息',
    whatsAppPhoneMissing: '请添加手机号以发送 WhatsApp 消息。',
    whatsAppButtonLabel: 'WhatsApp 登录',
    aiInsights: 'AI 智能分析',
    positiveTrend: '积极趋势',
    negativeTrend: '需要注意',
    overall: '综合总结',
